...
export default function UserBookings() {
    ...
    useEffect(()=>{
        ...
        .then((res) => {
            ...
            if (item.status.includes("Cancelled")) {
        ...
        axios.get(`${backendUrl}/payments/cancelledPaymentsByCustomer/${userData._id}`, {
            headers: {
                Authorization: `Bearer ${accessToken}`,
            },
        })
  ...
  return (
    <div className='h-screen pt-16'>
        <div className='flex'>
            <div className='w-[50%]'>
                <h1 className='text-2xl font-semibold text-center'>Your Bookings</h1>
            ...
            <div className='w-[50%]'>
                <h1 className='text-2xl font-semibold text-center'>Your Cancellations</h1>
